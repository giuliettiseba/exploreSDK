(function (undefined) {
  var loginManager = function (settings) {
    ...
    function initInternal() {
      ...
      findInner(".default-server").textContent =
        "(defaults to: " +
        (XPMobileSDKSettings.MobileServerURL || window.location.origin) +
        ")";
  ...
  loginManager.loadAndLogin = function (params) {
    function loadLoginManager() {
      var loginContainer, credentials;
      ...
      params.loginContainerId =
        params.loginContainerId || "login-form-container";
